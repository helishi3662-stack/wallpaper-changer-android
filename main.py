...
class MainLayout(BoxLayout):
    def __init__(self, service, **kwargs):
        ...
        self.folder_input = TextInput(
            text=service.config.get('folder_path', '/sdcard/Pictures'),
        ...
        self.total_label = Label(
            ...
            color=(0.2, 0.4, 1, 1), size_hint_y=None, height=30
        )
        self.add_widget(self.total_label)

        self.current_label = Label(
            text='当前壁纸: 未设置', color=(0, 0.6, 0, 1),
        ...
        self.status_label = Label(
            text='状态: 已停止', color=(0.5, 0.5, 0.5, 1),
            size_hint_y=None, height=30
        )
    ...
    def browse_folder(self, instance):
        ...
        popup = Popup(
            title='提示',
            content=Label(text='请手动输入图片文件夹路径，例如:\n/sdcard/Pictures/Wallpapers'),
            size_hint=(0.8, 0.4)
        )
        popup.open()
